...
const SoundSystem = () => {
    ...
    const currentPageItems = sound.slice(offset, offset + itemsPerPage);
    ...
    return (
        <>
            <div className="p-5 md:px-20 font-rhodium">
                ...
                <p className="text-tersier mb-5">Menampilkan {sound.length} produk</p>
                {/* CARDS */}
                ...
                <div className="w-screen mt-5">
                    ...
                    <ReactPaginate
                        ...
                        nextLabel={">"}
                        breakLabel={"..."}
                        pageCount={Math.ceil(sound.length / itemsPerPage)}
