...
const Led = () => {
    ...
    const currentPageItems = led.slice(offset, offset + itemsPerPage);
    ...
    return (
        <>
            <div className="p-5 md:px-20 font-rhodium">
                ...
                <p className="text-tersier mb-5">Menampilkan {led.length} produk</p>
                {/* CARDS */}
                ...
                <div className="w-screen mt-5">
                    ...
                    <ReactPaginate
                        ...
                        nextLabel={">"}
                        breakLabel={"..."}
                        pageCount={Math.ceil(led.length / itemsPerPage)}
